...
export default function StudentSignUpForm() {
  ...
  return (
    <>
      <h1 className="mb-6 text-center text-3xl font-bold">Student Sign Up</h1>
      <p className="mb-4 text-center text-sm text-muted-foreground">
        Create an account to join therapy sessions
      </p>
      ...
      >
        ...
        <form.Subscribe>
          {(state) => (
            ...
            >
              {state.isSubmitting ? "Creating Account..." : "Sign Up as Student"}
            </Button>
          )}
        </form.Subscribe>
      </form>
