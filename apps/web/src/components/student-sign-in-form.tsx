...
export default function StudentSignInForm() {
        ...
        },
        {
          onSuccess: async () => {
            ...
            if (sessionData.data) {
              ...
              // Navigate to home (will redirect to dashboard or onboarding based on profile)
              navigate({
                to: "/",
              });
  ...
  return (
    <>
      <h1 className="mb-6 text-center text-3xl font-bold">Student Sign In</h1>
      <p className="mb-4 text-center text-sm text-muted-foreground">
        Sign in to join your therapy sessions
      </p>
      ...
      >
        ...
        <form.Subscribe>
          {(state) => (
            ...
            >
              {state.isSubmitting ? "Signing in..." : "Sign In as Student"}
            </Button>
          )}
        </form.Subscribe>
      </form>
